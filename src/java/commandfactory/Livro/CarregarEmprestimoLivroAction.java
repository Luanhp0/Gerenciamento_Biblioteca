...
import commandfactory.Livro.ICommand;
 ...
 * @author drak
 */
public class CarregarEmprestimoLivroAction implements ICommand{
    @Override
    public String executar(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            request.setAttribute("msg", "Erro ao carregar livro para empréstimo.");
        }

        return "novoemprestimo.jsp";
    }
}
