...
import commandfactory.Emprestimo.ICommand;
     ...
     */
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String nomeDaClasse = "commandfactory.Emprestimo." + paramAction + "EmprestimoAction";
            ...
            e.printStackTrace();
            String msg = "Erro Genérico: " + e.getMessage();
