...
import commandfactory.FichaTecnica.AtualizarFichaTecnicaAction;
import commandfactory.FichaTecnica.CadastrarFichaTecnicaAction;
import commandfactory.FichaTecnica.ConsultarByIdFichaTecnicaAction;
import commandfactory.FichaTecnica.DeletaFichaTecnicaAction;
import DAO.FichaTecnicaDAO;
import commandfactory.FichaTecnica.ICommand;
...
public class FichaTecnicaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                String paramAction = request.getParameter("botao");
                
                String nomeDaClasse = "commandfactory.FichaTecnica."+paramAction+"FichaTecnicaAction";
